...
if (modified.includes(oldCode1)) {
  modified = modified.replace(oldCode1, newCode1);
...
if (modified.includes(oldCode2)) {
  modified = modified.replace(oldCode2, newCode2);
...
const finalContent = modified.replace(/\n/g, '\r\n');
