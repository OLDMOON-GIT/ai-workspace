...
해결방안:
1. 특정 폰트 하나만 사용하도록 고정
2. 우선순위 1번 폰트 없으면 에러 발생
3. 또는 config 파일로 폰트 명시',
  'open',
  JSON_OBJECT(
    'affected_files', JSON_ARRAY('trend-video-backend/src/video_generator/create_thumbnail.py'),
    'affected_lines', JSON_ARRAY(322, 323, 324, 334),
