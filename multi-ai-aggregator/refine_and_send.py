...
async def main(headless: bool = False, use_queue: bool = True):
    ...
    # Configuration
    initial_question = "막장드라마 제목 10개 써줘 (띄어써줘, 공백 제외 대략 30자)"
    refine_question_1 = "여기서 탑 3를 뽑아줘"
    refine_question_2 = "여기서 탑 3를 뽑아줘"
...
"""
            ...
            print(f"\n{Fore.YELLOW}Browser is still open. Press Enter to close and exit...{Style.RESET_ALL}")
            input()

            # Close browser after user confirmation
