...
export type PipelineModel = "gpt" | "gemini" | "claude" | "grok";
...
export async function POST(request: Request) {
  ...
  const allowedModels: PipelineModel[] = ["gpt", "gemini", "claude", "grok"];
  const model: PipelineModel = allowedModels.includes(modelInput as PipelineModel)
    ? (modelInput as PipelineModel)
    : "gpt";
