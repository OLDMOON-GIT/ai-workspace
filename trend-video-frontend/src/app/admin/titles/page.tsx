...
interface ScriptTask {
  ...
  createdAt: string;
  scriptPath?: string;
  promptFormat?: 'longform' | 'shortform' | 'sora2';
  logs?: Array<{
    timestamp: string;
    message: string;
  }>;
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {script.promptFormat && (
                        <span className={`px-2 py-1 rounded text-xs font-semibold ${
                          script.promptFormat === 'shortform' ? 'bg-blue-500/20 text-blue-300 border border-blue-500/30' :
                          script.promptFormat === 'longform' ? 'bg-green-500/20 text-green-300 border border-green-500/30' :
                          'bg-purple-500/20 text-purple-300 border border-purple-500/30'
                        }`}>
                          {script.promptFormat === 'shortform' ? '⚡ 숏폼' : script.promptFormat === 'longform' ? '📝 롱폼' : '🎬 Sora2'}
                        </span>
                      )}
