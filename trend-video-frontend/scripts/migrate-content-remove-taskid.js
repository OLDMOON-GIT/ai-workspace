/**
 * content 테이블에서 task_id 컬럼 제거
 *
 * Queue Spec v3: content_id = task_id (1:1 매핑)
 * 따라서 별도 task_id 컬럼 불필요
 */
...
function removeTaskIdColumn() {
  ...
  try {
    ...
    console.log('🚀 content 테이블 task_id 컬럼 제거 시작');
    ...
    if (!hasTaskId) {
      console.log('✅ task_id 컬럼이 이미 제거되었습니다.');
...
module.exports = { removeTaskIdColumn };
